(function ($) {
    ...
    var gsMethods = {
        ...
        createBanner:function () {
            var vDom = '';
            vDom += '<style>';
            vDom += '.hei #'+aCfg.son+'{background-image: url(http://image.gamersky.com/webimg15/tg/gitb3bg-hei.png);}';
            vDom += '#'+aCfg.son+'{background: url(http://image.gamersky.com/webimg15/tg/gitb3bg-bai.png) 0 46px repeat-x;}';
            vDom += '</style>';
