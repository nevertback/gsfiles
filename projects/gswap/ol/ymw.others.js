...
(function ($) {
    ...
    var openAppJs = {
        ...
        insertBtn:function () {
            var btnDom = '',thObj = this,thCfg = this.config;
            var u = navigator.userAgent;
            var isiOS = !!u.match(/\(i[^;]+;( U;)? CPU.+Mac OS X/);
            btnDom += '<a class="countHit countHitSql" data-itemid="1000245" style="'+thCfg.btnStyle+'" id="gsGotoApp">';
            ...
            $('#gsGotoApp').on('click',function () {
                ...
                function iosEvent(){
                    window.open('https://a.gamersky.com/app/news/'+thCfg.countId,'target');
                }
                if(isiOS){
                    iosEvent();
                }else{
        ...
        homeBtn:function () {
            var thObj = this,$btn = $('.gsOpenAppHome'),btnConfig={
                countIndex:995626,
                count:995625,
                countClass:'countHit countHitSql'
            },countId,isIndex = $btn.data('isindex');
            var u = navigator.userAgent;
            var isiOS = !!u.match(/\(i[^;]+;( U;)? CPU.+Mac OS X/);
            if(isIndex === 'yes'){
                countId = btnConfig.countIndex;
            }else{
                countId = btnConfig.count;
            }
            $btn.each(function () {
                var $this = $(this),tid;
            ...
            $btn.on('click',function () {
                ...
                function iosEvent(){
                    window.open('https://a.gamersky.com/app/home','target');
                }
                if(isiOS){
                    iosEvent();
                }else{
