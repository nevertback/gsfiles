    ...
    var openAppJs = {
        ...
        clkEvents:function (opt,cid,rel) {
            ...
            switch (opt) {
                case 'home':
                    if(isiOS){
                        //fakeAlink('https://a.gamersky.com/app/home?apprel='+rel);
                        fakeAlink('https://a.gamersky.com/app/home');
                    }else{
                        thObj.androidJump({
                            //schema: "home?apprel="+rel
                            schema: "home"
                        });
                    }
                    break;
                case 'game':
                    if(isiOS){
                        //fakeAlink('https://a.gamersky.com/app/home?apprel='+rel);
                        fakeAlink('https://a.gamersky.com/app/game');
                    }else{
                        thObj.androidJump({
                            //schema: "home?apprel="+rel
                ...
                case 'gamecon':
                    if(isiOS){
                        //fakeAlink('https://a.gamersky.com/app/news/'+cid+'?apprel='+rel);
                        fakeAlink('https://a.gamersky.com/app/game/'+cid);
                    }else{
                        thObj.androidJump({
                            //schema: "news?id="+cid+'&apprel='+rel
                ...
                case 'content':
                    if(isiOS){
                        //fakeAlink('https://a.gamersky.com/app/news/'+cid+'?apprel='+rel);
                        fakeAlink('https://a.gamersky.com/app/news/'+cid);
                    }else{
                        thObj.androidJump({
                            //schema: "news?id="+cid+'&apprel='+rel
                            schema: "news?id="+cid
                ...
                case 'strategy':
                    if(isiOS){
                        //fakeAlink('https://a.gamersky.com/app/news/'+cid+'?apprel='+rel);
                        fakeAlink('https://a.gamersky.com/app/game/'+cid+'/strategiesSet');
                    }else{
                        thObj.androidJump({
                            //schema: "news?id="+cid+'&apprel='+rel
        ...
        contentBtn:function (isback) {
            ...
            btnDom += '<a class="countHit countHitSql openGamerskyApp" data-approle="'+btnRoles+'" data-itemid="1000245" style="'+defaultCfg.btnStyle+'" id="gsGotoApp" data-appcid="'+btnCid+'" data-apprel="'+cfg.content.okcount+'">';
            btnDom += btnTxt;
            btnDom += '</a>';
        ...
        bindClk:function () {
            ...
            $('.openGamerskyAppDiy').on('click',function () {
                var $this = $(this),cid = $this.data('appcid'),rel = $this.attr('data-apprel');
                thObj.clkEvents('content',cid,rel);
            })
        },
        init:function () {
            this.writeBtn();
