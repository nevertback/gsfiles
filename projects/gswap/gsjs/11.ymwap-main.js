...
var ymwapJs = {
    ...
    fixTabNav:function(){
        ...
        function ymwTNF(){
            ...
            $('.ymwTabNavFixed').css({'width':$(window).width() - 28 + 'px'});
            $(window).scroll(function(){
                
            st = $(window).scrollTop();
            if(st >= ft){
                $('.ymwTabNavFixed').css({'position':'fixed','top':'0','left':'0','width':$(window).width() - 28 + 'px','z-index':'99992'}).parent().css({'padding-top':$('.ymwTabNavFixed').height()+20+'px'});
            }else{
                $('.ymwTabNavFixed').css({'position':'','top':'','left':'','z-index':'','width':''}).parent().css({'padding-top':''});
            }
            });
        }
        ymwTNF();
...
ymwapJs.doJs($('.ymw-glal-list'),ymwapJs.glFunc);
